    ...
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-bg-2.jpg)">
      <div class="container-fluid page-header-inner py-5">
        <div class="container text-center">
          <h1 class="display-3 text-white mb-3 animated slideInDown">Kendaraan Penumpang</h1>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center text-uppercase">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">SHOP</a></li>
              <li class="breadcrumb-item text-white active" aria-current="page">Kendaraan Penumpang</li>
            </ol>
          </nav>
        </div>
      </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
          <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 class="mb-5">Mobil Penumpang</h1>
          </div>
          <div class="row g-4">
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
              <div class="team-item">
                <div class="position-relative overflow-hidden">
                  <img class="img-fluid" src="img/car/Fortuner.jpeg" alt="" />
                  <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                    <h6 class="text-white mb-0">jenis bahan bakar : Diesel</h6>
                    <h6 class="text-white mb-0">tenaga : 148 hp</h6>
                    <h6 class="text-white mb-0">kapasitas mesin : 2393 cc</h6>
                  </div>
                </div>
                <div class="bg-light text-center p-4">
                  <h5 class="fw-bold mb-0">Fortuner</h5>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
              <div class="team-item">
                <div class="position-relative overflow-hidden">
                  <img class="img-fluid" src="img/car/CR-v.jpg" alt="" />
                  <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                    <h6 class="text-white mb-0">jenis bahan bakar : Bensin</h>
                    <h6 class="text-white mb-0">tenaga            : 152 hp</h>
                    <h6 class="text-white mb-0">kapasitas mesin   : 1997 cc</h6>
                  </div>
                </div>
                <div class="bg-light text-center p-4">
                  <h5 class="fw-bold mb-0">CR-V</h5>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
              <div class="team-item">
                <div class="position-relative overflow-hidden">
                  <img class="img-fluid" src="img/car/Alpart.jpeg" alt="" />
                  <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                    <h6 class="text-white mb-0">jenis bahan bakar : Petrol</h>
                    <h6 class="text-white mb-0">tenaga            : 178 hp</h>
                    <h6 class="text-white mb-0">kapasitas mesin   : 2494 cc</h6>
                  </div>
                </div>
                <div class="bg-light text-center p-4">
                  <h5 class="fw-bold mb-0">Alpart</h5>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
              <div class="team-item">
                <div class="position-relative overflow-hidden">
                  <img class="img-fluid" src="img/car/inofa.jpg" alt="" />
                  <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                    <h6 class="text-white mb-0">jenis bahan bakar : Bensin</h>
                    <h6 class="text-white mb-0">tenaga            : 137 hp</h>
                    <h6 class="text-white mb-0">kapasitas mesin   : 1998 cc</h6>
                  </div>
                </div>
                <div class="bg-light text-center p-4">
                  <h5 class="fw-bold mb-0">INOVA</h5>
                  <small>Rp.471.900.000</small>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-12 col-sm-6">
                      <select class="form-select border-0" style="height: 55px">
                        ...
                        <option value="1">Fourtuner</option>
                        <option value="2">Alpart</option>
